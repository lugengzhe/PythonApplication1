...
def init():
    ...
    psOptions.binary_location = 'C:\Program Files (x86)\Google\Chrome\Application\chrome.exe'
    psOptions.add_argument('--headless')
    psOptions.add_argument('--disable-gpu')
    psOptions.add_argument('--ignore-certificate-errors')
    driver=webdriver.Chrome(chrome_options=psOptions)
    return driver
def login():
    username = 'CZ868895'
    password = '@Zcd1992'
    ...
    WebDriverWait(driver,60,0.5).until(expected_conditions.presence_of_element_located((By.XPATH,"//div[@id='body-container']/header/div[2]/div/span[2]/div[2]/div[1]/div/form/div/div[1]/div[1]/div[2]/div[2]/input")))
